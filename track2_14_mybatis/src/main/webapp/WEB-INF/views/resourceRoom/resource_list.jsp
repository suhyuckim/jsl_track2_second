							...
							<c:choose>
								<c:when test="${v_count == for_count}">
									<tr>
										...
										<td>
											<c:if test="${dtos.getFile_1() ne null or dtos.getFile_2() ne null}">
...
%>
			<a href="/ResourceWriteForm" class="btn_write">글쓰기</a>
		</div>
	  </div>
	</div>
	<!-- end contents -->
