...
public class CommonUtil{
	public static String resFileDir = "C:/eclipse project/track2online/track2_14_mybatis/src/main/webapp/file_room/resource/";
	public static String file_dir_notice = "";
	public static String file_dir_news = "";
	
	// 로그인 session 정보 level
...
//		pagenumber = 5;   //한 화면의 페이지 인덱스수
		...
		if(current_page > pagenumber){
			...
			strList = strList +"<a href=javascript:goPage('"+curpage+"') class='icon'><i class='fa fa-angle-double-left'></i></a>";
		}
		...
		if(totalpage > endpage){
			curpage = endpage+1;
			strList = strList + "<a href=javascript:goPage('"+curpage+"') class='icon'><i class='fa fa-angle-double-right'></i></a>";
		}
		return strList;
	}			
	...
	public static String pageListGet(int current_page,int totalpage, String list_url){
		...
		if(current_page > pagenumber){
			curpage = startpage -1;  //시작페이지 번호보다 1적은 페이지로 이동
			strList = strList +"<a href=javascript:goPage('"+curpage+"')><i class='fas fa-angle-double-left'></i></a>";
		}
		...
		if(totalpage > endpage){
			curpage = endpage+1;
			strList = strList + "<a href=javascript:goPage('"+curpage+"')><i class='fas fa-angle-double-right'></i></a>";
		}
		return strList;
	}			
}