...
public class Faq_dao {
	...
	public Faq_dto getFaqView(String no) { //상세조회
		Faq_dto dto = null;
	...
	public String getFaqNo(){ //번호생성
		...
		try {
			...
			try { common.close(con, ps, rs); }catch(Exception e) {	System.out.println("醫낅즺 �삤瑜�~~"); }
		}	
		return no;
	}
	
	public ArrayList<Faq_dto> getFaqList() { //목록조회
