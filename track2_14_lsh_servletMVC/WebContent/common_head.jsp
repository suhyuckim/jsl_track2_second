			...
			<div id="header">
				<div class="nav">
						<ul class="nav-menu">
							...
							<li><a href="<%=request.getContextPath()%>/notice/notice_list.jsp">NOTICE</a></li>
						</ul>
				<div class="logo">
					<h1 class="el-logo"><a href="<%=request.getContextPath()%>/index.jsp"><img src="<%=request.getContextPath()%>/images/elwide-logo.svg" width="88" height="88"></a></h1>
				</div>
				<div class="side-bar">
					<div class="side-menu">
						<ul>
