...
public class Member_DAO {
	...
	public int deleteMember(String id) { //회원탈퇴
		...
		try {
			...
			try {
				...
				System.out.println("deleteMember close() 오류~:"+e.getMessage());
			}
		}
		return result;		
	}	
	...
	public int updateMember(String id, String name, String birth, String area, String address, String telecom, String phone_1, String phone_2, String phone_3,
						    String email_1, String email_2, String att_desk, String att_note, String att_print, String att_beam, String update_date) { //회원수정
		int result = 0;	
		...
		try {
			...
			try {
				...
				System.out.println("updateMember close() 오류~:"+e.getMessage());
			}
		}
		return result;		
	}		
	...
	public Member_DTO getMemberInfo(String memberId){ //멤버수정전 회원상세조회
		...
		try{
			...
			while(rs.next()){
				...
				email_1, email_2, att_desk, att_note, att_print, att_beam,reg_date,"",""); //따로 DTO문을 안만들어도 된다.
			}
		}catch(SQLException se){
	...
	public int insertMember(String id, String pw, String name, String birth, String area, String address, String telecom,
							...
							String att_note, String att_print, String att_beam, String reg_date){ //회원가입 등록
		int result = 0;
