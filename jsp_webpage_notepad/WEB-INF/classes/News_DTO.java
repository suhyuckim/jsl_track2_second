...
public class News_DTO{
	...
	public News_DTO(String news_no, String title, String content, String file_name_1, String reg_id, String reg_date, int hit){
		this.news_no 		= news_no;
		this.title 			= title;
		this.content 		= content;
	...
	public void setNotice_no(String news_no) {
		this.news_no = news_no;
	}
