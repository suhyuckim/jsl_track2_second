...
textarea {
	...
	<div id="content">
		...
		<div class="bord_list">
			<table class="bord_table">
				...
				<thead>
					<tr>
						<td>제&nbsp;&nbsp;목</td>
						<td id="title_box" style=text-align:left;>PC 구매절차 방법</td>
				...
				<tbody>
					<tr>
						...
						<textarea readonly>미리보기 미리보기 미리보기 미리보기 미리보기</textarea>
						</td>
					</tr>
				</tbody>
			</table>
		...
		<p style="text-align:center; padding-top:10px">
			...
			<input type="button" value="수 정" style="color:white;background:#42464d;width:50px;height:30px;border:none;">
		</p>
	</div>
<style>
#footer{
