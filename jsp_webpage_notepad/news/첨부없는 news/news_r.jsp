...
%> 	
					<tr>									
						<td><a href="news_v.jsp?t_newsNo=<%=dtos.get(k).getNews_no()%>"><%=dtos.get(k).getNews_no()%></a></td>
						<td class="title"><a href="news_v.jsp?t_newsNo=<%=dtos.get(k).getNews_no()%>"><%=dtos.get(k).getTitle()%></a></td>
