...
<%
	...
	if(selValue == null){
		...
		ArrayList<Qanda> dtos = dao.getQandaList(selValue,txtValue);
%>
	<div id="menu">
		<ul>
...
%>
					<tr>									
						<td><a href="qanda_v.jsp?t_qandaNo=<%=dtos.get(k).getQanda_no()%>"><%=dtos.get(k).getQanda_no()%></a></td>
						<td class="title"><a href="qanda_v.jsp?t_qandaNo=<%=dtos.get(k).getQanda_no()%>"><%=dtos.get(k).getTitle()%></a></td>
