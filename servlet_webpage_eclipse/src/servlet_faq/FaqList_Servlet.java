...
import dto.Faq_DTO;
/**
 * Servlet implementation class FaqList_Servlet
 */
@WebServlet("/FaqList_Servlet")
public class FaqList_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FaqList_Servlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Faq_DTO> dtos = dao.getFaqList_servlet(selValue, txtValue);
		int FaqCount = dao.getFaqCount();
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/faq/faq_list.jsp");
