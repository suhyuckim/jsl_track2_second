...
/**
 * Servlet implementation class NoticeUpdate_Servlet
 */
@WebServlet("/NoticeUpdate_Servlet")
public class NoticeUpdate_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public NoticeUpdate_Servlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(session_level == null) {
			...
			int result = dao.updateNotice_servlet(notice_no, title, content, saveFileName, reg_id, reg_date);
