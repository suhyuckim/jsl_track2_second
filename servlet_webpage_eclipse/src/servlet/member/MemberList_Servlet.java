...
/**
 * Servlet implementation class MemberList_Servlet
 */
...
public class MemberList_Servlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(checkValue == null){
			...
			int getMemberCount = dao.getMemberCount_servlet();
			request.setAttribute("MemberCount", getMemberCount);
			...
			request.setAttribute("selValue2", 	selValue2);
