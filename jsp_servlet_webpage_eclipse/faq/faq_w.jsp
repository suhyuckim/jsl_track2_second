					...
					<fieldset>
						...
						<table class="table">
							...
							<tr>
								...
								<td><input type="text" name="title" id="title" class="title" placeholder="질문을 입력해주세요"></td>
							</tr>
							
							<tr>
								<th><label for="cont">답변</label></th>
								<td><textarea type="cont" name="cont" id="cont" class="cont" placeholder="답변을 입력해주세요"></textarea>
							</tr>							
				
							<tr>
								<td colspan="2">
								<a href="javascript:faqcheck()"><input type="button" value="전송" class="btn" ></a>
