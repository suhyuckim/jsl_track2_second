...
/**
 * Servlet implementation class ScoreUpdateForm
 */
@WebServlet("/ScoreUpdateForm")
public class ScoreUpdateForm extends HttpServlet {
	private static final long serialVersionUID = 1L;
    public ScoreUpdateForm() {
        super();
    }
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rdp = request.getRequestDispatcher("/score/score_u.jsp");
