...
<%@ page import ="common.CommonUtil,dao.Notice_DAO, dto.Event_DTO"%>
<%
	...
	<body>
				...
				<input type="hidden" name="t_event_no"  value="<%=event_no%>">
					...
					<fieldset>
						...
						<table class="table">
							...
							<tr>
								<td colspan="6">
								<a href="javascript:eventcheck()"><input type="button" value="전송" class="btn" ></a>
		...
		<script>
			function eventcheck() {
				...
				write.action = "event_m_insert.jsp";
				write.method = "post";
				write.submit();
			}
		</script>
